  ...
  var OverlayTrigger = _React['default'].createClass({
    ...
    render: function render() {
      ...
      if (isOneOf('hover', this.props.trigger)) {
        props.onMouseEnter = (0, _createChainedFunction['default'])(this.handleDelayedShow, this.props.onMouseEnter);
        props.onMouseLeave = (0, _createChainedFunction['default'])(this.handleDelayedHide, this.props.onMouseLeave);
      }
